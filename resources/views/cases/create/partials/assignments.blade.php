...
<div class="mb-6">
    ...
    <div class="border rounded-lg p-4 bg-gray-50">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @foreach(\App\Models\User::whereCurrentRole('alu_atty')->orderBy('name')->get() as $attorney)
...
<div class="mb-6">
    ...
    <div class="border rounded-lg p-4 bg-gray-50">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @foreach(\App\Models\User::whereCurrentRole('alu_clerk')->orderBy('name')->get() as $clerk)
                <label class="flex items-center p-2 border rounded hover:bg-white cursor-pointer">
