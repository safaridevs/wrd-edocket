        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white rounded-lg shadow-lg max-w-3xl w-full">
                <div class="p-6">
                    ...
                    <p class="text-sm text-gray-600 mb-4">The case filer will be notified to make corrections:</p>

                    <div class="bg-red-50 rounded-lg p-4 mb-4">
                        <h4 class="font-medium text-sm mb-2">Responsible Filer:</h4>
                        <div class="text-sm py-1">
                            • {{ $case->creator->name }} (Case Creator) - {{ $case->creator->email }}
                        </div>
                        @if(false && $case->assignedAttorney)
                        <div class="text-sm py-1">
