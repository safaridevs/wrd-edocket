...
class CaseCreationRules
{
    ...
    public function validationRules(?string $caseType): array
    {
        ...
        if ($caseType === 'compliance') {
            ...
            $rules['compliance_doc_type'] = 'nullable|in:compliance_order,pre_compliance_letter,compliance_letter,notice_of_violation,notice_of_reprimand,notice_of_contemplated_action,other';
